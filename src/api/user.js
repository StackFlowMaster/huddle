 ...
 */
export const login = (loginIdentity, pinCode, validationCode) => {
...
/**
 * Fetch the activity for the given profile
 *
 * @param {string} profileCode
 */
export const fetchActivity = (profileCode) => api.post(RESOURCE, 'getActivity', {}, { accessContext: { profileCode } });
 ...
 * @param {*} data.custom
 */
export const addActivity = (data, profileCode) => {
  const { description, eventType, custom = {} } = data || {};
  ...
  return api.post(RESOURCE, 'addActivity', bundle, { accessContext: { profileCode } });
};
