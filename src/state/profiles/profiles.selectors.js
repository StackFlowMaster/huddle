...
const isMasterProfile = (profile) =>
  profile && profile.profileType === profileTypes.Normal && profile.master;
...
export const writeAccessProfilesSelector = createSelector(
  ...
  (profiles) => profiles.filter((profile) => {
    const writeAccess = profile && profile.profileType !== profileTypes.CareTeamReadonly;
    return writeAccess;
  }),
);
